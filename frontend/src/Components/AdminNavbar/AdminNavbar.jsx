                ...
                {isOpen && (
                    <div className='lg:hidden'>
                        <div className='px-2 pt-2 pb-3 space-y-1'>
                            <Link to='/admin/posts' className='block hover:bg-gray-700 px-3 py-2 rounded' onClick={() => setIsOpen(false)}>
                                게시글
                            </Link>
                            <Link to='/admin/contacts' className='block hover:bg-gray-700 px-3 py-2 rounded' onClick={() => setIsOpen(false)}>
                                문의 관리
                            </Link>
