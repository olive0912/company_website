...
import HeroImage from '../../assets/team-construction.jpg'
            ...
            <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-36'>
                <div className='flex flex-col lg:flex-row items-center justify-between gap-12'>
                    <div className='flex-1 text-center lg:text-left'>
                        ...
                        <p className='text-lg sm:text-xl text-gray-800 text-semibold mb-8 mx-auto'>
                            안전하고 효율적인 태양광 설비 설치부터 유지보수까지, 전문가들이 함께합니다.
                        </p>
                        <div className='flex flex-col sm:flex-row gap-4 justify-center lg:justify-start'>
                            <button className='px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 font-semibold shadow-lg hover:shadow-xl'>
                                상담 신청하기
                            </button>
                    ...
                    <div className='flex-1 w-full max-w-2xl lg:max-w-none'>
                        <div className='relative'>
                            <img src={HeroImage} className='relative rounded-2xl shadow-2xl w-full object-cover transform hover:scale-[1.02] transition-transform duration-300'></img>
                        </div>
                    </div>
                </div>
            </div>
