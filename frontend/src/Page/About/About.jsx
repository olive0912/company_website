...
import companyImage from "../../assets/city1.jpg";

const About = () => {
  return (
    <div className="container mx-auto px-4 py-32 max-w-7xl bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-24">
        {[
          { title: "혁신", content: "끊임없는 도전과 혁신으로 미래를 선도합니다" },
          { title: "신뢰", content: "고객과의 신뢰를 최우선 가치로 삼습니다" },
          { title: "성장", content: "구성원들의 지속적인 성장을 지원합니다" }
        ].map((value, i) => (
          <div
            key={i}
          ...
          >
            ...
            <p className="text-gray-600 text-lg">{value.content}</p>
          </div>
        ))}
      </div>
