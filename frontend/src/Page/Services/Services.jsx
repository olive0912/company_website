      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16'>
        {
          servicesList.map((service) => (
            <div key={service.id} className='bg-white p-8 rounded-lg shadow-lg hover:-translate-y-2 transition-transform duration-300'>
              ...
              <div className='text-xl font-semibold text-gray-800 mb-4'>{service.title}</div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          {
            [
              ...
              <div key={i} className='relative p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300'>
